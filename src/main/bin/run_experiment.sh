...
main() {
  ...
  input_checks $@
	...
	hdfs://172.31.19.91:9000$BASE_PATH hdfs://172.31.19.91:9000/spark/applicationHistory $PARTITIONS $EXPERIMENT > job_logs_$PARTITIONS.log &
