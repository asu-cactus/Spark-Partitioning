...
parser.add_argument('numPages',  metavar='numPages', type=int, default=1000000, help='number of pages')
parser.add_argument('maxLinks', metavar='maxLinks', type=int, default=1000, help='maximum number of links')
...
assert numPages >  maxLinks and maxLinks > 0
